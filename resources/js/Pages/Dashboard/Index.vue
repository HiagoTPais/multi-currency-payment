...
<template>
    ...
    <AppLayout>
        <div class="flex items-end justify-between gap-4">
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-blue-600">Dashboard</p>
                <h1 class="mt-2 text-3xl font-bold text-slate-950">Payment overview</h1>
            </div>
        ...
        <p v-if="error" class="mt-6 rounded-xl bg-rose-50 px-4 py-3 text-sm text-rose-700">{{ error }}</p>
        <section class="mt-8 rounded-2xl bg-slate-950 p-6 text-white shadow-sm">
            ...
            <p v-else class="mt-4 text-sm text-slate-300">Loading exchange rate...</p>
        </section>
